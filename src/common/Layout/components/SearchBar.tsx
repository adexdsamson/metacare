  ...
  return (
    <div className="relative w-96 rounded-[10px] h-[90%]">
      <input
        ...
        className="h-full w-full bg-[#FAFAFC] rounded-[10px] ring-0 outline-0 pl-5 font-gelion text-subbody leading-29 placeholder:text-[#A3A3C2] placeholder:font-gelion placeholder:text-subbody"
        {...props}
      />
